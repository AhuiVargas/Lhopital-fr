    ...
    <Html>
      ...
      >
        ...
        >
          ...
          <Heading style={{ color: "#b01f29", fontSize: "22px", marginBottom: "24px" }}>
            Nuevo mensaje de contacto
          </Heading>

          <Text><strong>Nombre:</strong> {name}</Text>
          <Text><strong>Email:</strong> {email}</Text>
          <Text><strong>Teléfono:</strong> {phone}</Text>
          {subject && <Text><strong>Asunto:</strong> {subject}</Text>}
          ...
          <Text style={{ fontSize: "12px", color: "#999999", marginTop: "40px", textAlign: "center" }}>
            Este mensaje fue enviado desde el formulario de contacto de lhopital-fr.mx
          </Text>
        </Container>
      </Body>
    </Html>
